...
<div class = "event_details">
	<form action="" method="POST">
		...
		<div class="form-group">
			<label style="position:absolute;left:-20px;top:250px;" class="control-label col-sm-2" >Enter Number:-</label>
				
					<input style= "position:absolute;left:100px;top:250px;" type="text" class="form-control" id="name" placeholder="Registration number" name="search" value="">
				
		</div>
  <div class="container">
			  <button style="position:absolute;left:150px;top:350px;" type="submit" id= "sear" class="btn btn-primary" name="submit">Search</button>
